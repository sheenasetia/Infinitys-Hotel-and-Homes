        ...
        <div className="row">
            ...
            <div className="column middle ">
              <div className="row">
                ...
                {this.props.cityResponse.length!==0?<h3>Infinitys in {this.props.cityResponse["0"].city}</h3>:<h3> </h3>}
                </div>
        ...
        {this.props.cityResponse.length===0?<h2 style={{margin:"60px"}} align="center"> No Results Found ... </h2>:
            this.props.loading?<LoadingIndicator/>:
              this.props.cityResponse.map((res,id)=>(
                ...
                <hr/>
                    <div className="main_col"> 
                        <img src={res.main_photo_url} alt="not available" />
                    </div>
                    <div className="main_col">
                        <h3>{res.hotel_name}</h3>
                        <h6>Near {res.address}, {res.city}</h6>
                        <p>Ratings : {res.facilities_review_score.rating} - {res.facilities_review_score.rating_message}</p>
                        <p>Available rooms : {res.available_rooms}</p>
                        <h5 style={{color:"red" }}>Price : {res.min_total_price.toFixed(2)} INR </h5>
                        <div className="main_row">
                            <div style={{width:"50%" , float:"left"}}> 
